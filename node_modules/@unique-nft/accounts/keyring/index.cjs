...
class KeyringAccount extends types.KeyringAccountBase {
...
class KeyringProvider extends types.Provider {
  constructor(options = {}) {
    super();
    this.options = options;
    __publicField(this, "keyring");
    this.keyring = new keyring.Keyring(options);
  }
...
exports.KeyringAccount = KeyringAccount;
