...
declare class BaseClient implements IBaseClient {
    instance: AxiosInstance;
    readonly options: Options;
    readonly extrinsic: IExtrinsics;
...
declare const CHAIN_CONFIG: Record<`${Chains}`, ChainConfig>;

declare class ThinClient extends BaseClient {
    readonly options: Options;
    readonly common: ICommon;
    readonly balance: IBalance;
    readonly fungible: IFungible;
    readonly refungible: IRefungible;
    readonly collection: ICollection;
    readonly token: IToken;
    readonly erc721: IERC721;
    readonly ipfs: IIpfs;
    readonly stateQuery: IStateQueries;
    readonly defaults: Options;
    constructor(options: Options);
}

declare class Sdk extends ThinClient implements IClient {
    readonly options: Options;
    /**
