  ...
  var require_utf_helpers = __commonJS({
    "node_modules/utf-helpers/index.js"(exports, module) {
      ...
      var HexString5 = {
        ...
        fromU8a: (bytes2) => HexString5.fromArray(bytes2),
        toArray(hexString) {
        ...
        toU8a: (hexString) => Uint8Array.from(HexString5.toArray(hexString))
      };
      var Utf82 = {
        stringToU8a(str) {
        ...
        stringToHexString(str) {
          return HexString5.fromU8a(Utf82.stringToU8a(str));
        },
        hexStringToString(hexString) {
          return Utf82.u8aToString(HexString5.toU8a(hexString));
        },
        lengthInBytes(str) {
          let len = 0;
          let c = 0;
      ...
      var Utf162 = {
        stringToU16a(str) {
          const u16arr = new Uint16Array(Utf162.lengthInBytes(str));
          let i = 0;
          while (i < str.length) {
        ...
        stringToNumberArray(str) {
          return Array.from(Utf162.stringToU16a(str));
        },
        numberArrayToString(arr) {
          let i = 0;
        ...
        u16aToString(arr) {
          return Utf162.numberArrayToString(arr);
        },
        lengthInBytes(str) {
          let i = 0;
          while (i < str.length) {
