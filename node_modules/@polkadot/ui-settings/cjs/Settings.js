...
class Settings {
    ...
    constructor() {
        ...
        this.__internal__ledgerApp = withDefault(index_js_1.LEDGER_APP, settings.ledgerApp, index_js_1.LEDGER_APP_DEFAULT);
    ...
    set(settings) {
        ...
        this.__internal__ledgerApp = settings.ledgerApp || this.__internal__ledgerApp;
